...
|:----------|:----------------|:--------|:-------|
| Angular   | Demo is running | [Website](https://contenta-angular.firebaseapp.com/) | [Repo](https://github.com/contentacms/contenta_angular) |
| Angular 4 | Planned         | Not yet | Not yet |
| Elm       | Demo is running | [Website](https://contenta-elm.firebaseapp.com/) | [Repo](https://github.com/contentacms/contenta_jsonapi__elm) |
| Ember     | Needs help      | Not yet | [Repo](https://github.com/contentacms/contenta_ember) |
| Ionic     | Demo is running | Not yet | [Repo](https://github.com/contentacms/contenta_ionic) |
| React     | In progress     | Not yet | [Repo](https://github.com/contentacms/contenta_react) |
| Vue.js    | Demo is running | Not yet | [Repo](https://github.com/contentacms/contenta_vue_nuxt) |
